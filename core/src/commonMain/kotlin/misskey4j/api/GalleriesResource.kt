...
interface GalleriesResource {
     ...
     */
    fun posts(request: ListGalleryPostsRequest?): Response<Array<ListGalleryPostsResponse?>?>?
     ...
     */
    fun posts(request: IListGalleryPostsRequest?): Response<Array<ListGalleryPostsResponse?>?>?
     ...
     */
    fun posts(request: ListUserGalleryPostsRequest?): Response<Array<ListGalleryPostsResponse?>?>?
     ...
     */
    fun show(request: ShowGalleryPostRequest?): Response<GalleryPost?>?
     ...
     */
    fun create(request: CreateGalleryPostRequest?): Response<GalleryPost?>?
     ...
     */
    fun delete(request: DeleteGalleryPostRequest?): Response<java.lang.Void?>?
     ...
     * @see "https://misskey.io/api-doc.operation/gallery/posts/delete"
     */
    fun update(request: UpdateGalleryPostRequest?): Response<GalleryPost?>?
     ...
     */
    fun like(request: LikeGalleryPostRequest?): Response<java.lang.Void?>?
     ...
     */
    fun like(request: UnlikeGalleryPostRequest?): Response<java.lang.Void?>?
}
